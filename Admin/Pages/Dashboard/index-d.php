                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            if(isset($_GET['search']))
                            {
                                ...
                                $totalSearchData = mysqli_query($con, "SELECT* from object WHERE type_id='3' AND name LIKE'%$filtervalues%'");
                                ...
                                JOIN type_of_object USING(type_id)  WHERE object.type_id='3' AND object.name LIKE '%$filtervalues%' LIMIT $firstData,$dataLimit";
                                ...
                                type_of_object.name 'type', author.author_id 'author_id', author.name 'author'
                                FROM  OBJECT JOIN author USING(author_id) 
                                JOIN type_of_object USING(type_id) WHERE object.type_id='3' ORDER BY object.object_id LIMIT $firstData,$dataLimit;";
                                ...
                                if(mysqli_num_rows($result)>0){
                                    foreach($result as $rows){
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-btn-col">
                                                <div class="add-btn">
                                                    <a class="ref" href="delete.php? id=<?=$rows['edit_id'];?>">Delete </a> 
                                                </div>    
                                                <div class="add-btn">
                                                    <a class="ref" href="delete.php? id=<?=$rows['edit_id'];?>">Edit </a> 
                                                </div>
                                            </td>
                                        </tr>
                                        <?php
