            ...
            <tbody>
                <tr>
                    <td width="225" style="border-width:0 10px 0 0; border-color: black; " valign="top">
                        <h2 class="title">Shounen no Abyss</h3>
                        <div class="picture">
                                            ...
                                            <div>
                                                <table>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="cast-pic"><img class="cast-pic" src="Icon.png" alt=""></td>
                                                            <td>Akiyama, Sakuko</td>
                                                            <td></td>
                                                            <td class="cast-pic"><img class="cast-pic" src="Icon.png" alt=""></td>
                                                            <td >Shibasawa, Yuri</td>
                                                        ...
                                                        <tr>
                                                            <td class="cast-pic"><img class="cast-pic" src="Icon.png" alt=""></td>
                                                            <td>Shino'oka, Saki</td>
                                                            <td></td>
                                                            <td class="cast-pic"><img class="cast-pic" src="Icon.png" alt=""></td>
                                                            <td >Fukami, Kazumasa</td>
