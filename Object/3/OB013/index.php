...
$rate_count = 0;
$avg_rate =0;
$query = "SELECT rate FROM rating_table WHERE username='$username' AND object_id='OB013' LIMIT 1";
...
$query1 = "SELECT COUNT(rate) 'rate_count' FROM rating_table WHERE object_id='OB013' GROUP BY(object_id)";
...
$query2 = "SELECT ROUND(AVG(rate),2) 'avg_rate' FROM rating_table WHERE object_id='OB013' GROUP BY(object_id)";
                                            ...
                                            <table style="border-bottom: 2px solid #CDDEEE;" width="100%">
                                                ...
                                                <col width="200px">
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td > 
                                                        <a href="../../../Pages/Drama/add.php?id=OB013" class="add-btn">+</a>
                                                         </td>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <table>
                                                    <tbody>
                                                        ...
                                                        <tr >
                                                            ...
                                                            <td>
                                                                <div class="cast">MAtsuyuki, Yasuko</div>
                                                                <div class="role">Suzuhara, Nao</div>
                                                            </td>
                                                            <td></td>
                                                            <td class="cast-pic"> <img class="cast-pic" src="Icon.png" alt=""> </td>
                                                            <td>
                                                                <div class="cast">Ashida, Mana</div>
                                                                <div class="role">Michiki, Rena</div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="cast-pic"><img class="cast-pic" src="Icon.png" alt=""></td>
                                                            <td>
                                                                <div class="cast">Ono, Machiko</div>
                                                                <div class="role">Michiki, Hitomi</div>
                                                            </td>
                                                            <td></td>
                                                            <td class="cast-pic"><img class="cast-pic" src="Icon.png" alt=""></td>
                                                            <td>
                                                                <div class="cast">Ayano, Go</div>
                                                                <div class="role">Uragami, Masato</div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="cast-pic"><img class="cast-pic" src="Icon.png" alt=""></td>
                                                            <td>
                                                                <div class="cast">Yamamoto, Koji</div>
                                                                <div class="role">Shunsuke,  fujiyoshiKai, Hayato</div>
                                                            </td>
                                                            <td></td>
                                                            <td class="cast-pic"><img class="cast-pic" src="Icon.png" alt=""></td>
                                                            <td>
                                                                <div class="cast">Tanaka,  Minoru</div>
                                                                <div class="role">Fujiyoshi, Kensuke</div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="cast-pic"><img class="cast-pic" src="Icon.png" alt=""></td>
                                                            <td>
                                                                <div class="cast">Sakai, Wakana</div>
                                                                <div class="role">Suzuhara, Mei</div>
                                                            </td>
                                                            <td></td>
                                                            <td class="cast-pic"><img class="cast-pic" src="Icon.png" alt=""></td>
                                                            <td>
                                                                <div class="cast">Takahata, Atsuko</div>
                                                                <div class="role">Suzuhara, Toko</div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td class="cast-pic"><img class="cast-pic" src="Icon.png" alt=""></td>
                                                            <td>
                                                                <div class="cast">Kurashima, kana</div>
                                                                <div class="role">Suzuhara, Kaho</div>
                                                            </td>
                                                            <td></td>
                                                            <td class="cast-pic"><img class="cast-pic" src="Icon.png" alt=""></td>
                                                            <td>
                                                                <div class="cast">Tanaka,  Yuuko</div>
                                                                <div class="role">Mochizuki, Hana</div>
                                                            </td>
