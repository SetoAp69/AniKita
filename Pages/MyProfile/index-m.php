                        ...
                        <tbody>
                            ...
                            if(isset($_GET['search']))
                            {
                                ...
                                $totalSearchData = mysqli_query($con,"SELECT* FROM rating_table JOIN object USING (object_id)
                                 WHERE username='$username' AND object.name LIKE '%$filtervalues%' AND object.type_id='2'");
                                ...
                                WHERE u.username='$username' AND o.object_id=r.object_id  AND o.type_id='2'
                                ...
                                //diplay all data
                                ?> <?php
                                $queryx="SELECT* FROM rating_table JOIN object USING(object_id) where username='$username' AND object.type_id='2' ";
                                ...
                                FROM user u, object o, author a, type_of_object t, rating_table r 
                                WHERE u.username='$username' AND o.object_id=r.object_id AND t.type_id=o.type_id  AND o.type_id='2'
